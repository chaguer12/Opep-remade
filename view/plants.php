...
<body>
    ...
    <header class="header sticky top-0 bg-white z-10 shadow-md flex items-center justify-between px-8 py-02">
        ...
        <div class="w-3/12 flex justify-end gap-5">
            ...
            <a href="../view/signin.php" class="flex items-center mr-4 hover:text-purple-700 duration-200">
    ...
    <section class="bg-[#1A0B2D] pt-5 w-auto">
        ...
        <form class="max-w-lg m-auto flex flex-col  items-center" action="" method="post">
            <label for="categorie" class="text-white py-3 text-2xl text-center font-semibold">Filter Plants by Categorie</label>
            
            <select id="categorie" name="categorie" class="w-full p-2 rounded-md bg-white text-black">
            ...
            <input type="submit"  name="searchByCategory"
    ...
    <section class="flex w-auto flex-wrap items-center justify-center bg-[#1A0B2D] pt-10 ">
        <?php
        $plant = new PlantDAO();
        if(!(isset($_POST['searchByCategory'])) || $_POST["categorie"] === 'all'){
            $plants = $plant->getPlant1();
            
        }else{
            $cat_id = $_POST['categorie'];
            $plants = $plant->FilterPlant($cat_id);
        }
        // var_dump($_SESSION);
        ...
        <div class="relative flex-shrink-0 max-w-xs mx-2 mb-6 overflow-hidden bg-purple-500 rounded-lg shadow-lg mb-9">
            ...
            <div class="relative flex items-center justify-center px-10 pt-10">
                ...
                <img class="h-64 w-64" src="data:image/jpg;charset=utf8;base64,<?=  base64_encode($plant['image']); ?>" alt="Plant Image">
            </div>
            <div class="relative px-6 pb-6 mt-6 text-white">
                <div class="flex justify-between">
                    ...
                    <form action="../includes/cartitems.php" method="post">
