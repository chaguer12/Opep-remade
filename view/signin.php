...
<body>
    ...
    <div class="h-screen md:flex">
        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
            <form class="bg-white" method="POST" action="../includes/login.php" id="form">
                ...
                <?php
                    if (isset($_GET['error'])) {
                        ?>
                        <p class="text-sm text-danger text-center mt-4">Invalid values!</p>
                        <?php
                    }
                    ?>
                <button type="submit" name="login" class="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">connect
                </button>
